...
@Model(adaptables = SlingHttpServletRequest.class, adapters = {Image.class, ComponentExporter.class}, resourceType = ImageImplV2.RESOURCE_TYPE)
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME, extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class ImageImplV2 extends ImageImplV1 implements Image {

    public static final String RESOURCE_TYPE = "core/wcm/components/image/v2/image";
    private static final Logger LOGGER = LoggerFactory.getLogger(ImageImplV2.class);
    ...
    protected void initModel() {
        ...
        if (StringUtils.isNotEmpty(fileReference)) {
            LOGGER.debug("fileReference from ImageImplV2: " + fileReference);
        ...
        if (hasContent) {
            ...
            LOGGER.debug("V2 src:" + src);
            LOGGER.debug("V2 srcUriTemplate:" + srcUriTemplate);
            buildJson();
        }
    }
