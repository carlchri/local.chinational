...
public class ProfileCarouselManual {
 
    private static final Logger LOGGER = LoggerFactory.getLogger(ProfileCarouselManual.class);
	@Inject
	...
	public java.util.List<String> populateModel(
		...
		if (resource != null) {
			...
			while (linkResources.hasNext()) {
				String identifier = linkResources.next().getValueMap().get("profileTileIdentifier", String.class);
				array.add(identifier);
		  	   contentTilesList.add("ProfileTile" + "-" + i++);
			}
		}
