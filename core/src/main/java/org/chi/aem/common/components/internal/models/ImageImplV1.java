/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
package org.chi.aem.common.components.internal.models;
...
@Model(adaptables = SlingHttpServletRequest.class, adapters = {Image.class, ComponentExporter.class}, resourceType = ImageImplV1.RESOURCE_TYPE)
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME, extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class ImageImplV1 implements Image {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ImageImplV1.class);
    ...
    protected void initModel() {
        ...
        if (StringUtils.isNotEmpty(fileReference)) {
            LOGGER.debug("fileReference from ImageImplV1: " + fileReference);
        ...
        LOGGER.debug("V1 hasContent: " + hasContent);
        if (hasContent) {
            ...
            LOGGER.debug("V1 baseResourcePath: " + baseResourcePath);
            ...
            src += (inTemplate ? Text.escapePath(templateRelativePath) : "") + (lastModifiedDate > 0 ? "/" + lastModifiedDate + DOT +
                    extension : "");
            LOGGER.debug("V1 src:" + src);
            if (!isDecorative) {
                if (StringUtils.isNotEmpty(linkURL)) {
                    linkURL = LinkUtils.getURL(request, pageManager, linkURL);
                }
            } else {
                linkURL = null;
                alt = null;
