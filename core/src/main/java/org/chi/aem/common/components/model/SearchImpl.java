...
@Model(adaptables = SlingHttpServletRequest.class,
       ...
       resourceType = {org.chi.aem.common.components.model.SearchImpl.RESOURCE_TYPE})
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME ,
          extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class SearchImpl implements Search {

    protected static final String RESOURCE_TYPE = "chinational/components/structure/search_v2";

    public static final int PROP_RESULTS_SIZE_DEFAULT = 3;
