...
/*
 * Copied the code from ACS, as it does not work fur multiple sites
 * Modified it to work with multiple sites
 *
 *
 * */
...
@Component(metatype = true, label = "CHI - Site Map Servlet", description = "CHI Page and Asset Site Map Servlet", configurationFactory = true, policy = ConfigurationPolicy.REQUIRE)
@Service
...
@Properties({
        ...
        @Property(name = "sling.servlet.selectors", value = "sitemapchi", propertyPrivate = true),
        @Property(name = "sling.servlet.extensions", value = "xml", propertyPrivate = true),
        @Property(name = "sling.servlet.methods", value = "GET", propertyPrivate = true),
        @Property(name = "webconsole.configurationFactory.nameHint", value = "CHI Site Map for: {externalizer.domain}, on resource types: [{sling.servlet.resourceTypes}]") })
public final class SiteMapServlet extends SlingSafeMethodsServlet {

    public static final Logger LOGGER = LoggerFactory.getLogger(SiteMapServlet.class);
