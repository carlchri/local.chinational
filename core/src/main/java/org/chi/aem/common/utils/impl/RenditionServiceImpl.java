...
import org.chi.aem.common.utils.RenditionsService;
 ...
 */
@Component(
        name="CHI National Asset Renditions Generator...",
        metatype = true, immediate = true
)
@Property(name="service.description", value="CHI National Generate JPEG Renditions for Images")
@Service
